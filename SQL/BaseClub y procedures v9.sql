...
insert into cuotaSocio (NSocio, Monto, FechaPago, MetodoPago, FechaInicio, Vencimiento) values (1,3000, 20231013, 1, 20231013, 20231113);
insert into cuotaSocio (NSocio, Monto, FechaPago, MetodoPago, FechaInicio, Vencimiento) values(2,3000, 20231013, 1, 20231013, 20231113);
insert into cuotaSocio(NSocio, Monto, FechaPago, MetodoPago, FechaInicio, Vencimiento) values(2,3000, 20231114, 1, 20231114, 20231214);
...
insert into cuotaDiaria (NSocio, Monto, FechaPago, MetodoPago, FechaInicio, Vencimiento) values(1,400, 20231024, 1, 20231024, 20231124);
 ...
 begin
     ...
     if existe is null then
		set rta = 0; /* no existe el socio, mal puesto el dni */
     	 ...
     	 insert into cuotaSocio (NSocio, Monto, FechaPago, MetodoPago, FechaInicio, Vencimiento) values (inNSocio, inMonto, inFechaPago, inMetodoPago, inFechaInicio, inVencimiento);
		 set rta  = 1;
	 end if;		 
...
delimiter //
 ...
 begin
	 ...
	 insert into cuotaDiaria (NSocio, Monto, FechaPago, MetodoPago, FechaInicio, Vencimiento) values (inNSocio, inMonto, inFechaPago, inMetodoPago, inFechaInicio, inVencimiento);
