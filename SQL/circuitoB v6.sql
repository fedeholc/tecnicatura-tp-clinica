...
-- -----------------------------------------------------
-- Table `CircuitoB`.`Usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CircuitoB`.`Usuario` ;

CREATE TABLE IF NOT EXISTS `CircuitoB`.`Usuario` (
...
insert into CircuitoB.Usuario (Nombre,Pass,Rol) values
('Admin','1234',1),
('Recepcion', '1234', 2),
('Especialista', '1234', 3);
